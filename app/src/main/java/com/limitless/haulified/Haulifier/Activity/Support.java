    ...
    public void initialize() {
        ...
        four.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://139.59.1.185:8080/support"));
                startActivity(browserIntent);
            }
        });

        webview.getSettings().setJavaScriptEnabled(true);
        if (NetworkUtility.isNetworkConnectionAvailable(Support.this)) {

            webview.loadUrl("http://139.59.1.185:8080/support");
        }else
        {
            Toast.makeText(Support.this, "No Internet !", Toast.LENGTH_SHORT).show();
        }
