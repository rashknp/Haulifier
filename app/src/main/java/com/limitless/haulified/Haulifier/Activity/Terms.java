    ...
    public void initialize() {
        ...
        four.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://139.59.1.185:8080/terms"));
                startActivity(browserIntent);
            }
        });

        webview.getSettings().setJavaScriptEnabled(true);
        if (NetworkUtility.isNetworkConnectionAvailable(Terms.this)) {

            webview.loadUrl("http://139.59.1.185:8080/terms");
        }else
        {
            Toast.makeText(Terms.this, "No Internet !", Toast.LENGTH_SHORT).show();
        }
