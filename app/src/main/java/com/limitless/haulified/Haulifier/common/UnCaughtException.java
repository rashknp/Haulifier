...
//	private static final String RECIPIENT = "bits@masafi.com";

    private static final String aEmailList[] = {"vishal.sharma@limitlessmobil.com"};
    private static final String aEmailCCList[] = {};//{ "venky@limitlessmobil.com","suhail@blaseit.com" };
                        ...
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog,
                                ...
                                Intent sendIntent = new Intent(
                                        Intent.ACTION_SEND);
                                String subject = "Starkey Log.";//Farm Fresh MH Van Sales
...
//								sendIntent.putExtra(android.content.Intent.EXTRA_BCC, aEmailBCCList);
                ...
                builder.setMessage("Sorry for inconvenience.Starkey app stopped working.");
