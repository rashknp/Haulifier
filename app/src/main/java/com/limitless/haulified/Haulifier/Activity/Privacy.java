    ...
    public void initialize() {
        ...
        four.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://139.59.1.185:8080/privacy"));
                startActivity(browserIntent);
            }
        });

        webview.getSettings().setJavaScriptEnabled(true);
        if (NetworkUtility.isNetworkConnectionAvailable(Privacy.this)) {

            webview.loadUrl("http://139.59.1.185:8080/privacy");
        }else
        {
            Toast.makeText(Privacy.this, "No Internet !", Toast.LENGTH_SHORT).show();
        }
